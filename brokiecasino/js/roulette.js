// v2.14 (Baseline) - User Confirmed Working Structure
...
if (typeof initRoulette === 'undefined') {
    ...
    function initRoulette(API) {
        ...
        console.log("Roulette Initialized (v2.14 - Baseline)");
    }
    ...
    function hideBall() {
        ...
        if (rouletteBall) {
            ...
            if (wheelElement && containerElement && rouletteBall.parentElement === wheelElement) {
                ...
                } catch (e) { console.error("Error moving ball back to container:", e); }
            }
        }
        ballLanded = false;
    }
    ...
    function animateBall(timestamp) {
        ...
        // Update ball angle based purely on physics speed (v2.14)
        ...
        if (elapsed >= BALL_ANIMATION_DURATION) {
            ...
            console.log(`Ball landed instantly at Index: ${targetWinningNumberIndex}`);
